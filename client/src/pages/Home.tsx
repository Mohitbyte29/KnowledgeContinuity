          ...
          <div className="flex flex-col w-full">
              ...
              <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-space-2xl items-center">
                ...
                <div className="lg:col-span-6 flex flex-col items-start space-y-space-md z-10">
                  ...
                  <p className="font-body-lead text-body-lead text-[#44474d] max-w-xl pt-space-xs">
                    Continuity turns past PRs, Slack threads, and incident
                    postmortems into instant, verified answers before knowledge
                    leaves with attrition.
                  </p>
                  ...
                  <div className="pt-space-xs flex items-center gap-2 font-code-md text-code-md text-[#505f78]">
                    ...
                    <span>
                      Zero disruption to existing workflows · Integrates with
                      GitHub, Slack &amp; Jira in minutes
                    </span>
                  </div>
                </div>
                      ...
                      <div className="absolute right-0 sm:right-3 max-w-[240px] sm:max-w-[270px] z-10">
                        <div className="bg-[#192435] border border-[#c5a059]/70 p-4 shadow-xl text-left relative">
                          ...
                          <p className="font-body-sm text-[11px] text-[#8a99b5] pt-1 leading-relaxed">
                            Direct port bypass on primary cluster applied
                            2024-03-14 during checkout saturation.
                          </p>
              ...
              <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-space-2xl">
                ...
                <div className="lg:col-span-5 flex flex-col justify-center space-y-space-md pr-0 lg:pr-6">
                  ...
                  <div className="space-y-space-sm text-[#44474d] font-body-md text-body-md leading-relaxed">
                    <p>
                      Every senior engineer holds months of unwritten context in
                      their head—why connection pools were bypassed at 3 AM, how
                      edge-case migrations were solved, and what failed before
                      it worked.
                    </p>
                    <p>
                      When they leave, teams spend hundreds of hours
                      rediscovering the same wheel, retracing deleted branch
                      histories, and reconstructing forgotten rationale.
                    </p>
                  </div>
                  {/* Metric Callouts */}
                    ...
                    <div className="flex items-start gap-3 p-3.5 bg-[#e8dfd3] border-l-2 border-[#223148]">
                      ...
                      <div>
                        ...
                        <span className="font-body-sm text-xs text-[#505f78]">
                          Reconstructing historical context for legacy
                          infrastructure.
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="p-5 sm:p-7 space-y-5 bg-[#fff8f3]">
                      ...
                      <div className="p-4 bg-[#ffffff] border border-[#d2c7b8] space-y-2 relative">
                        ...
                        <p className="font-headline-sm text-base text-[#0c1c32] font-serif">
                          Checkout DB Socket Exhaustion &amp; PgBouncer Thread
                          Locking
                        </p>
                        <p className="font-body-sm text-xs text-[#44474d] leading-relaxed">
                          High concurrency checkout spikes caused PgBouncer
                          transaction pooling to queue stale file handles.
                          Direct connection routing bypassed the pooling daemon
                          temporarily to recover throughput. Attributed to{" "}
                          <strong className="text-[#0c1c32]">
                            @sarah-chen
                          </strong>{" "}
                          (Principal DBRE).
                        </p>
                      ...
                      <div className="p-3.5 bg-[#0c1c32] text-[#f3eae0] font-code-md text-xs space-y-1.5 overflow-x-auto">
                        <div className="flex items-center justify-between pb-1 text-[#8a99b5] text-[10px] border-b border-[#223148]">
                          <span>
                            deploy/helm/services/checkout-worker.yaml (commit
                            eb419f0)
                          </span>
              ...
              <div className="max-w-7xl mx-auto space-y-space-2xl">
                ...
                <div className="max-w-3xl space-y-space-xs">
                  ...
                  <p className="font-body-lead text-body-lead text-[#8a99b5]">
                    ...
                    engineering communication into durable, verifiable
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="p-7 bg-[#1c293d] border border-[#2f486d] hover:border-[#c5a059] transition-colors duration-200 flex flex-col justify-between group">
                    <div className="space-y-4">
                      ...
                      <p className="font-body-sm text-body-sm text-[#8a99b5] leading-relaxed">
                        Natural language queries return the exact decision
                        rationale and implementation history in seconds,
                        bypassing stale readmes.
                      </p>
                    </div>
                  ...
                  <div className="p-7 bg-[#1c293d] border border-[#2f486d] hover:border-[#c5a059] transition-colors duration-200 flex flex-col justify-between group">
                    <div className="space-y-4">
                      ...
                      <p className="font-body-sm text-body-sm text-[#8a99b5] leading-relaxed">
                        Every answer links back directly to the immutable PR
                        diff, Slack author quote, or Jira resolution for
                  ...
                  <div className="p-7 bg-[#1c293d] border border-[#2f486d] hover:border-[#c5a059] transition-colors duration-200 flex flex-col justify-between group">
                    <div className="space-y-4">
                      ...
                      <p className="font-body-sm text-body-sm text-[#8a99b5] leading-relaxed">
                        Passive ingestion of resolved incident channels and
                        merged engineering pull requests without demanding
                        manual wiki upkeep.
                      </p>
                    </div>
                    <div className="pt-6 mt-4 border-t border-[#2f486d]/50">
                  ...
                  <div className="p-7 bg-[#1c293d] border border-[#2f486d] hover:border-[#c5a059] transition-colors duration-200 flex flex-col justify-between group">
                    <div className="space-y-4">
                      ...
                      <p className="font-body-sm text-body-sm text-[#8a99b5] leading-relaxed">
                        Contextual reading lists and historical deep-dives
                        tailored dynamically to your repository layout and
                        domain architecture.
                      </p>
                    </div>
                    <div className="pt-6 mt-4 border-t border-[#2f486d]/50">
                  ...
                  <div className="p-7 bg-[#1c293d] border border-[#2f486d] hover:border-[#c5a059] transition-colors duration-200 flex flex-col justify-between group">
                    <div className="space-y-4">
                      ...
                      <p className="font-body-sm text-body-sm text-[#8a99b5] leading-relaxed">
                        Query directly by error stack trace, socket timeout
                        signature, or memory leak pattern rather than brittle
                        keywords.
                      </p>
                    </div>
                    <div className="pt-6 mt-4 border-t border-[#2f486d]/50">
                  ...
                  <div className="p-7 bg-[#1c293d] border border-[#2f486d] hover:border-[#c5a059] transition-colors duration-200 flex flex-col justify-between group">
                    <div className="space-y-4">
                      ...
                      <p className="font-body-sm text-body-sm text-[#8a99b5] leading-relaxed">
                        A living topological map of subsystem component
                        ownership, historical code authors, and cross-team
                        dependencies.
                      </p>
                    </div>
                    <div className="pt-6 mt-4 border-t border-[#2f486d]/50">
            ...
            <section className="w-full bg-[#d2c7b8] text-[#0c1c32] px-margin-mobile md:px-margin-desktop py-space-3xl md:py-space-4xl">
              <div className="max-w-7xl mx-auto space-y-space-2xl">
                ...
                <div className="mt-12 grid gap-4 md:grid-cols-2 text-gray-200">
                  <button
                    type="button"
                    aria-pressed={click}
                    className={`group relative text-left rounded-2xl border p-6 transition-all duration-200 sm:p-8 ${
                      click
                        ? "border-[hsl(var(--accent))] bg-[#1c293d] shadow-[0_15px_40px_hsl(var(--accent)/.09)]"
                        : "border-[hsl(var(--border))] bg-[#1c293d] hover:-translate-y-1 hover:border-[hsl(var(--primary)/.38)]"
                    }`}
                    data-testid="button-persona-leaving"
                    onClick={() => setClick(true)}
                  >
                    <span className="flex text-white h-11 w-11 items-center justify-center rounded-xl bg-[hsl(var(--accent)/.14)] text-[hsl(var(--accent))]">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={20}
                        height={20}
                    ...
                    <span className="mt-9 text-gray-200 block text-xl font-semibold tracking-[-.035em]">
                      I’m leaving something behind
                    </span>
                    <span className="mt-2 block max-w-xs text-sm leading-relaxed text-[hsl(var(--muted-foreground))]">
                      Capture the context only you carry before your next
                      chapter.
                    </span>
                    <span
                      className={`absolute right-6 top-6 flex h-6 w-6 items-center justify-center rounded-full border ${
                        click
                          ? "border-[hsl(var(--accent))] bg-[#1c293d] text-[hsl(var(--accent-foreground))]"
                  ...
                  <button
                    ...
                    data-testid="button-persona-taking-over"
                    onClick={() => setClick(false)}
                  >
                    <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[hsl(270_38%_53%/.14)] text-[hsl(270_38%_53%)]">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={20}
                        height={20}
                    ...
                    <span className="mt-9 block text-xl font-semibold tracking-[-.035em]">
                      I’m taking something on
                    </span>
                    <span className="mt-2 block max-w-xs text-sm leading-relaxed text-[hsl(var(--muted-foreground))]">
                      Find the decisions, relationships, and shortcuts that
                      matter now.
                    </span>
                    <span
                      className={`absolute right-6 top-6 flex h-6 w-6 items-center justify-center rounded-full border ${
                ...
                <div className="flex justify-center pt-2">
                  <button
                    type="button"
                    className="inline-flex h-12 items-center justify-center gap-2 bg-[#223148] px-8 font-label-md text-label-md uppercase tracking-wider text-[#f3eae0] transition-colors hover:bg-[#2f486d]"
                    onClick={() => navigate(click ? "/capture" : "/ask")}
                  >
                    Continue
